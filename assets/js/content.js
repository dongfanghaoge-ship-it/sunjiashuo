...
const skills = [
  ...
  { label: "计算传播方法与编程能力", detail: "掌握 Python 语言，修读自然语言处理、大数据推断、数据思维等课程" },
  { label: "内容分析与实证研究", detail: "以内容分析法完成数据新闻历时性研究，参与省级社科研究课题" },
  { label: "大模型应用", detail: "研究大语言模型在中文议题编码中的可靠边界与人机协同模式，熟练使用 AI Agent 工具" },
  { label: "影视创作", detail: "在省级电视台担任导演助理，参与影视作品创作并入选高校展映" },
